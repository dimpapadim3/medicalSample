...
namespace Business.Interfaces
{
    ...
    {
        List<QuestionnaireTemplate> GetQuestionnairHistoricalViewData(int userId, string locale,DateTime now, int numberToRecords);
        List<QuestionnaireTemplate> GetQuestionnairHistoricalViewData(int userId, string locale,int numberToRecords);
        ...
        QuestionnaireTemplate GetSubmitQuestionnaireTemplate(int i, string defaultQuestionnaireLocale, out GenericError error, DateTime getServerDateTime, int userId);
