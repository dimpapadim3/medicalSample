...
namespace Business.Questionnaire.QuestioannaireTemplates
{
    ...
    /// 
    /// </summary>
    public class QuestioannaireTemplateWeek2 : QuestioannaireTemplateBuilderBase
    {
        public override IQuestionnaireElementsCalculationAlgorithm QuestionnaireCalculationAlgorithm
        {
            get
            {
                return     new QuestionnaireCalculationAlgorithmWeek2(); 
            }
        }
        public override IQuestionnaireCoreScoreCalculationAlgorithm QuestionnaireCoreScoreCalculationAlgorithm
        {
            get { return new QuestionnaireCalculationAlgorithmWeek2(); }
        }
    ...
    public class QuestionnaireCalculationAlgorithmWeek2 : QuestionnaireCalculationAlgorithmBase
    {
        ...
        {
            QuestionnaireSummaryData data = new QuestionnaireSummaryData() { Value = new List<double>() };
